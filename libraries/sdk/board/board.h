...
#define BOARD_DEBUG_UART_INSTANCE DEBUG_UART
    ...
    /* Keil MDK 编译器 */
    extern unsigned char Image$$ARM_LIB_HEAP$$Base[];
    extern unsigned char Image$$ARM_LIB_HEAP$$ZI$$Limit[];
    
    #define HEAP_BEGIN Image$$ARM_LIB_HEAP$$Base
...
/* SDRAM内存区域定义 */
#define SDRAM_BEGIN (0x80000000u)  /* SDRAM起始地址: 2GB处 */
#define SDRAM_END (0x81E00000u)    /* SDRAM结束地址: 约30MB大小 */
#define SDRAM_SIZE ((uint32_t)SDRAM_END - (uint32_t)SDRAM_BEGIN)

/* Flash存储器大小 */
#define BOARD_FLASH_SIZE (0x400000U)  /* 4MB Flash */
